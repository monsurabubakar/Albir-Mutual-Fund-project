...
<html lang="en">
<head>
<title>Regsuccess :: Albir investment club Bootstrap Responsive Website | regsuccess :: Monsur</title>    
...
<body>
	...
	<div class="clearfix"></div>
		...
		<div class="agileits typography">
			...
			<?php
echo "<h2> Registration successful. <br/> Welcome onboard to Albir investnment club;</h2><br/>";
echo "<h3>You can now proceed to <a href='memberlogin.php'> Login</a></h3>";
?>
